            ...
            <div className="flex flex-col lg:flex-row gap-6">
              <section className="flex-1">
                ...
                <div className="flex flex-wrap">
                  ...
                  <p className="text-sm mb-2">Das Beispiel einer Rahmengeschichte liefern Ada und Gottfried, die als Lehrkräfte digitale Medien verwenden. Dabei werfen sie stellvertretend für die Lernenden Fragen auf oder reflektieren den Einsatz. Entstanden im Rahmen des <a href={`https://ilias.uni-hannover.de/goto.php?target=pg_58988_29146&client_id=ilias`} target="_blank" className="underline hover:text-red transition">Projekts digitaLe</a> an der Leibniz Universität Hannover. </p>
                </div>
              </section>
              ...
              <section className="flex-1">
                ...
                <div className="flex flex-wrap">
                  ...
                  <p className="text-sm mb-2">Für den Journalistinnenbund organisierte Sylvia Feil in der <a href={`https://journalistinnen.de/projekte/das-medienlabor/`} target="_blank" className="underline hover:text-red transition">AG Medienlabor</a> eine medienpolitische Diskussionsveranstaltung. Die Reihe bietet einen fachlichen Austausch zu medienpolitischen Fragen.</p>
